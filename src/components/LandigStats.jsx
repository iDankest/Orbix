...
const { data: nextLaunchData, loading, error } = useFetch("https://fdo.rocketlaunch.live/json/launches/next/1");
const nextLaunch = nextLaunchData?.result?.[0];
const { days, hours, minutes, seconds, isOver } = useCountdown(nextLaunch?.sort_date * 1000);
const { data: events } = useFetch("https://ll.thespacedevs.com/2.2.0/event/upcoming/");
...
value={nextLaunch ? nextLaunch.name.split('|')[0] : "Buscando..."}
    subtitle={countdownText}
      ...
      <CardDash
        ...
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-rocket"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 13a8 8 0 0 1 7 7a6 6 0 0 0 3 -5a9 9 0 0 0 6 -8a3 3 0 0 0 -3 -3a9 9 0 0 0 -8 6a6 6 0 0 0 -5 3" /><path d="M7 14a6 6 0 0 0 -3 6a6 6 0 0 0 6 -3" /><path d="M15 9l-3 3l3 3l-3 3" /></svg>
        }
    ...
    icon={
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-square-plus-2"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M12.5 21h-7.5a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v7.5" /><path d="M16 19h6" /><path d="M19 16v6" /></svg>
    }
    color="text-cyan-400"
  />
    </section>
